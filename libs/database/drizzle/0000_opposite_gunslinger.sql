...
ALTER TABLE "cad_beneficios" ADD CONSTRAINT "fk_funcionario_beneficios" FOREIGN KEY ("funcionario_id") REFERENCES "public"."cad_funcionarios"("funcionario_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cad_beneficios" ADD CONSTRAINT "fk_beneficios" FOREIGN KEY ("lookup_id") REFERENCES "public"."cad_lookup"("lookup_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cad_diarias" ADD CONSTRAINT "fk_diarias_projetos" FOREIGN KEY ("projeto_id") REFERENCES "public"."cad_projetos"("projeto_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cad_diarias" ADD CONSTRAINT "fk_diarias_funcionarios" FOREIGN KEY ("funcionario_id") REFERENCES "public"."cad_funcionarios"("funcionario_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cad_diarias" ADD CONSTRAINT "fk_diaria_lookup" FOREIGN KEY ("tipo_diaria") REFERENCES "public"."cad_lookup"("lookup_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cad_funcionarios" ADD CONSTRAINT "fk_funcionarios_projetos" FOREIGN KEY ("projeto_id") REFERENCES "public"."cad_projetos"("projeto_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cad_funcionarios" ADD CONSTRAINT "fk_funcionarios_funcao" FOREIGN KEY ("funcao") REFERENCES "public"."cad_lookup"("lookup_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cad_projetos" ADD CONSTRAINT "fk_projeto_empresa" FOREIGN KEY ("empresa_id") REFERENCES "public"."cad_empresas"("empresa_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
